...
from text_extraction.database.database import insert_row
from text_extraction.apis.strings import default_headers
from config import USER_EMAIL, API_KEY_TO_NAME, API_URL_TO_NAME, DOWNLOAD_DIR, DB_CACHE_FILE, LOG_DIR
    ...
    def _cache_successful_download(self, pub: Publication) -> None:
        ...
        if pub.publication_filepath:
            ...
            insert_row(doi=pub.doi, downloaded_from=self.name,
                       publication_filepath=str(pub.publication_filepath), db_path=DB_CACHE_FILE)
