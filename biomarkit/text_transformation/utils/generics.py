...
from biomarkit.config import JSON_STRUCT_DIR, FINAL_MARKDOWN_DIR, BASE_DIR, DB_CACHE_FILE_NAME
...
def check_vllm_config() -> None:
    ...
    """
    from biomarkit.config import MINERU_VLLM_ENDPOINT, MINERU_API_KEY
