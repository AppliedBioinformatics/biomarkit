...
def test_wiley_client_init(publications, caplog):
    ...
    with patch("text_extraction.apis.clients.wiley.TDMClient", return_value=fake_tdm_client) as mock_tdm, \
         patch("text_extraction.apis.clients.wiley.WILEY_TDM_TOKEN", "test_token"):
...
def test_wiley_client_missing_token(publications):
    ...
    with patch("text_extraction.apis.clients.wiley.WILEY_TDM_TOKEN", None):
