...
MODULE = "text_extraction.apis.abc.playwright_publisher_api"
...
def _make_client(publications):
    ...
    with patch(f"{MODULE}.API_URL_TO_NAME", {"unpaywall": "https://api.unpaywall.org/v2/"}), \
         patch("text_extraction.apis.abc.publisher_api.API_URL_TO_NAME", {"dummy": "http://dummy"}), \
         patch("text_extraction.apis.abc.publisher_api.API_KEY_TO_NAME", {"dummy": ""}), \
